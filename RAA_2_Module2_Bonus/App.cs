...
namespace RAA_2_Module2_Bonus
{
    internal class App : IExternalApplication
    {
        public Result OnStartup(UIControlledApplication app)
        {
            ...
            ButtonDataClass myButtonData = new ButtonDataClass("btnRAA_2_Module2_Bonus", "Batch Type\rParameter Setter", Command.GetMethod(), Properties.Resources.Green_32, Properties.Resources.Green_16, "This is a tooltip");
